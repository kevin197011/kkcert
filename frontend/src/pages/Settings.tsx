...
export default function SettingsPage() {
  ...
  return (
    <div>
      <PageHeader title="系统设置" subtitle="ACME、GoDaddy、Git 同步与定时任务配置" />
      <form onSubmit={handleSave}>
        ...
        <div className="card">
          <h3 style={{ marginBottom: 16 }}>OIDC 单点登录</h3>
          <div className="form-group">
            <label className="checkbox-label">
        ...
        <div className="card">
          <h3 style={{ marginBottom: 16 }}>GoDaddy DNS</h3>
          <div className="form-row">
            <div className="form-group">
              <label>API Key</label>
        ...
        <div className="card">
          <h3 style={{ marginBottom: 16 }}>Git 同步</h3>
          <div className="form-group">
            <label>仓库地址</label>
        ...
        <div className="card">
          <h3 style={{ marginBottom: 16 }}>续签策略</h3>
          <div className="form-row">
            <div className="form-group">
              <label>提前续签天数</label>
        ...
        <div className="card">
          <h3 style={{ marginBottom: 16 }}>API Token（机器调用）</h3>
          <div className="form-group">
            <label>API Token</label>
            <input value={settings.api_token} onChange={e => update('api_token', e.target.value)} placeholder="留空则不修改" />
          </div>
        </div>
